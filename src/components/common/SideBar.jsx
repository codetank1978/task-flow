...
export default function SideBar() {
  return (
    <div className="fixed left-0 top-0 h-full w-14 bg-slate-800 flex flex-col items-center py-4 gap-6">
      {/* Logo */}
      ...
      <nav className="flex flex-col gap-6">
        ...
        <Link href="/customers" className="text-white bg-gray-700 p-1 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
